...
public class test {
    ...
    public static final String SOBJ = "sobj"; //查询obj
    ...
    //购买存款产品
    public static final String ANSWER_DEPOSIT = "我们的存款产品有存款产品一号，存款产品二号，您可以查询，购买，卖出";//需要一个util方法，替换字符串里的槽位，后面放若干个数值
    public static final String ANSWER_DEPOSIT_BUY = "您需要购买的存款产品是存款产品一号";
    public static final String ANSWER_OBJ = "请说购买金额和年限";
    public static final String ANSWER_DEPOSIT_COMPLETE = " 您现在要购买xx，金额yy元，kk年，请说，确定，已确认购买";
    ...
    public static final String ANSWER_SOBJ = "介绍具体产品信息，你还有什么要问我的么";
    public static final String ANSWER_COMPARE = "介绍差异，如果您想购买哪个请说序号或者产品名字";
    ...
    public static final Map<String, String> IntentQA = new HashMap<String, String>() {
        {
            ...
            put(keySplit(DEPOSIT,BUY,BOBJ), ANSWER_OBJ);//用户选定第几个，响应：购买年限和金额
            put(keySplit(DEPOSIT, BUY, COMPLETE), ANSWER_DEPOSIT_COMPLETE);//用户说年限和金额，响应：确认购买
            ...
            put(SOBJ,ANSWER_SOBJ);//用户说第几个，响应：第几个产品具体信息
            put(keySplit(SEARCH,COMPARE),ANSWER_COMPARE);//用户说差异，响应：介绍差异
